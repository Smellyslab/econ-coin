...
so the second you make a transaction, it goes through and you get your money taken and they get theirs and you dont need to mine blocks to complete transactions. as it uses json files as a db which can quickly be edited so they are instant
```py
